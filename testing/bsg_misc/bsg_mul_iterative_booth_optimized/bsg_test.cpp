#include "verilated.h"
#include "obj_dir/Vbsg_mul_iterative_booth_optimized.h"
...
Vbsg_mul_iterative_booth_optimized *container[use_thread_p];

void performTesting(int bias){
    Vbsg_mul_iterative_booth_optimized *dut = container[bias];
...
int main(int argc, char **argv){
    ...
    for(int i = 0; i < use_thread_p; ++i){
        container[i] = new Vbsg_mul_iterative_booth_optimized{};
