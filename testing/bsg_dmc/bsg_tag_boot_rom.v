...
always_comb case(addr_i)
        ...
        30: data_o = width_p ' (23'b0001___1___11011_0_0111___01111111); // 0x0F677F
                                 // #SEND  en   id=28  r l=3
        31: data_o = width_p ' (23'b0001___1___11100_0_0111___00000111); // 0x0F8707
                                 // ################################################################################
                                 // #
                                 // # START CONFIGURATION
                                 // #
        ...
        32: data_o = width_p ' (23'b0001___1___11000_1_0001___00000000); // 0x0F1100
        33: data_o = width_p ' (23'b0001___1___11000_1_0001___00000001); // 0x0F1101
        34: data_o = width_p ' (23'b0001___1___11000_1_0001___00000000); // 0x0F1100
                                 // ### Set osc triggers low
                                 // #SEND  en   id=26   d l=1    {trigger}
        35: data_o = width_p ' (23'b0001___1___11010_1_0001___00000000); // 0x0F5100
                                 // ### Program the raw oscillators speed
                                 // #SEND  en   id=25   d l=5    {adt, cdt, fdt}
        36: data_o = width_p ' (23'b0001___1___11001_1_0101___00011011); // 0x0F351B
                                 // ### Trigger oscillators
                                 // #SEND  en   id=26   d l=1    {trigger}
        37: data_o = width_p ' (23'b0001___1___11010_1_0001___00000001); // 0x0F5101
        38: data_o = width_p ' (23'b0001___1___11010_1_0001___00000000); // 0x0F5100
                                 // #SEND  en   id=27   d l=7    {ds_val, reset}
        39: data_o = width_p ' (23'b0001___1___11011_1_0111___00000001); // 0x0F7701
        40: data_o = width_p ' (23'b0001___1___11011_1_0111___00000000); // 0x0F7700
                                 // ### Set delay line triggers low
                                 // #SEND  en   id=5  d l=1    {trigger}
        41: data_o = width_p ' (23'b0001___1___00101_1_0001___00000000); // 0x0CB100
                                 // #SEND  en   id=6  d l=1    {trigger}
        42: data_o = width_p ' (23'b0001___1___00110_1_0001___00000000); // 0x0CD100
                                 // #SEND  en   id=7  d l=1    {trigger}
        43: data_o = width_p ' (23'b0001___1___00111_1_0001___00000000); // 0x0CF100
                                 // #SEND  en   id=8  d l=1    {trigger}
        44: data_o = width_p ' (23'b0001___1___01000_1_0001___00000000); // 0x0D1100
                                 // ### Program the delay lines
                                 // #SEND  en   id=1  d l=5    {adt, cdt, fdt}
        45: data_o = width_p ' (23'b0001___1___00001_1_0101___00011111); // 0x0C351F
                                 // #SEND  en   id=2  d l=5    {adt, cdt, fdt}
        46: data_o = width_p ' (23'b0001___1___00010_1_0101___00011111); // 0x0C551F
                                 // #SEND  en   id=3  d l=5    {adt, cdt, fdt}
        47: data_o = width_p ' (23'b0001___1___00011_1_0101___00011111); // 0x0C751F
                                 // #SEND  en   id=4  d l=5    {adt, cdt, fdt}
        48: data_o = width_p ' (23'b0001___1___00100_1_0101___00011111); // 0x0C951F
                                 // ### Trigger delay lines
                                 // #SEND  en   id=5  d l=1    {trigger}
        49: data_o = width_p ' (23'b0001___1___00101_1_0001___00000001); // 0x0CB101
        50: data_o = width_p ' (23'b0001___1___00101_1_0001___00000000); // 0x0CB100
                                 // #SEND  en   id=6  d l=1    {trigger}
        51: data_o = width_p ' (23'b0001___1___00110_1_0001___00000001); // 0x0CD101
        52: data_o = width_p ' (23'b0001___1___00110_1_0001___00000000); // 0x0CD100
                                 // #SEND  en   id=7  d l=1    {trigger}
        53: data_o = width_p ' (23'b0001___1___00111_1_0001___00000001); // 0x0CF101
        54: data_o = width_p ' (23'b0001___1___00111_1_0001___00000000); // 0x0CF100
                                 // #SEND  en   id=8  d l=1    {trigger}
        55: data_o = width_p ' (23'b0001___1___01000_1_0001___00000001); // 0x0D1101
        56: data_o = width_p ' (23'b0001___1___01000_1_0001___00000000); // 0x0D1100
                                 // ### Async delay line reset to get things moving
                                 // #SEND  en   id=0  d l=1    {async_reset}
        57: data_o = width_p ' (23'b0001___1___00000_1_0001___00000000); // 0x0C1100
        58: data_o = width_p ' (23'b0001___1___00000_1_0001___00000001); // 0x0C1101
        59: data_o = width_p ' (23'b0001___1___00000_1_0001___00000000); // 0x0C1100
                                 // ### Set downsamples and reset
                                 // #
                                 // #SEND  en   id=9  d l=3    {ds_val, reset}
        60: data_o = width_p ' (23'b0001___1___01001_1_0011___00000001); // 0x0D3301
        61: data_o = width_p ' (23'b0001___1___01001_1_0011___00000000); // 0x0D3300
                                 // #SEND  en   id=28   d l=3    {clk_monitor_ds_val, reset}
        62: data_o = width_p ' (23'b0001___1___11100_1_0011___00000011); // 0x0F9303
        63: data_o = width_p ' (23'b0001___1___11100_1_0011___00000010); // 0x0F9302
                                 // # Reset DMC configs and set dmc_p
                                 // #SEND  en   id=10  d l=8    {trefi[7:0]}
        64: data_o = width_p ' (23'b0001___1___01010_1_1000___11111111); // 0x0D58FF
                                 // #SEND  en   id=11  d l=8    {trefi[15:8]}
        65: data_o = width_p ' (23'b0001___1___01011_1_1000___00000011); // 0x0D7803
                                 // #SEND  en   id=12  d l=8    {trfc, tmrd}
        66: data_o = width_p ' (23'b0001___1___01100_1_1000___11110001); // 0x0D98F1
                                 // #SEND  en   id=13  d l=8    {trp, trc}
        67: data_o = width_p ' (23'b0001___1___01101_1_1000___00111011); // 0x0DB83B
                                 // #SEND  en   id=14  d l=8    {trrd, tras}
        68: data_o = width_p ' (23'b0001___1___01110_1_1000___00101000); // 0x0DD828
                                 // #SEND  en   id=15  d l=8    {twr, trcd}
        69: data_o = width_p ' (23'b0001___1___01111_1_1000___10110010); // 0x0DF8B2
                                 // #SEND  en   id=16  d l=8    {trtp, twtr}
        70: data_o = width_p ' (23'b0001___1___10000_1_1000___10101001); // 0x0E18A9
                                 // #SEND  en   id=17  d l=8    {dqs_sel_cal, cas}
        71: data_o = width_p ' (23'b0001___1___10001_1_1000___00110011); // 0x0E3833
                                 // #SEND  en   id=18  d l=8    {row_width, col_width}
        72: data_o = width_p ' (23'b0001___1___10010_1_1000___11101011); // 0x0E58EB
                                 // #SEND  en   id=19  d l=8    {bank_pos, bank_width}
        73: data_o = width_p ' (23'b0001___1___10011_1_1000___01100110); // 0x0E7866
                                 // #SEND  en   id=20  d l=8    {init_cycles[7:0]}
        74: data_o = width_p ' (23'b0001___1___10100_1_1000___01001010); // 0x0E984A
                                 // #SEND  en   id=21  d l=8    {init_cycles[15:8]}
        75: data_o = width_p ' (23'b0001___1___10101_1_1000___10011100); // 0x0EB89C
                                 // #SEND  en   id=22  d l=8    {reset}
        76: data_o = width_p ' (23'b0001___1___10110_1_1000___00000001); // 0x0ED801
        77: data_o = width_p ' (23'b0001___1___10110_1_1000___00000000); // 0x0ED800
                                 // # SEND en  id=23 d l=8     {stall_transmission}
        78: data_o = width_p ' (23'b0001___1___10111_1_1000___00000000); // 0x0EF800
                                 // ################################################################################
                                 // #
                                 // # Done!
                                 // #
                                 ...
                                 // # Assert done_o
        79: data_o = width_p ' (23'b0011___0000000000000000000); // 0x180000
   default: data_o = 'X;
endcase
endmodule
