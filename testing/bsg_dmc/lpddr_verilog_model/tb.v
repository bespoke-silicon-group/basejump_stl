...
`endif
    ...
    real                        tck;
    wire                 [11:0] trc   = tRC;
    wire                 [11:0] trrd  = tck == 0 ? 0 : ceil(tRRD/tck);
    wire                 [11:0] trcd  = tck == 0 ? 0 : ceil(tRCD/tck);
    wire                 [11:0] tras  = tck == 0 ? 0 : ceil(tRAS/tck);
    wire                 [11:0] twr   = tck == 0 ? 0 : ceil(tWR/tck);
    wire                 [11:0] trp   = tck == 0 ? 0 : ceil(tRP/tck);
    wire                 [11:0] tmrd  = tMRD;
    wire                 [11:0] trfc  = tck == 0 ? 0 : ceil(tRFC/tck);
