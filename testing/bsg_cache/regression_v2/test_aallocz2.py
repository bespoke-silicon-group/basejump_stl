...
class TestAallocz2(TestBase):
  # This test make sure cache_line allocation with data zero-out works with either cache miss or cache hit
  # emphasizes on the correctness
  # A aallocz variation of test_aalloc1
