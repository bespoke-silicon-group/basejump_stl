...
proc bsg_link_sdr_constraints { \
  ...
  set_driving_cell -no_design_rule -lib_cell "CKBD4BWP30P140" $in_clk_port
  set_driving_cell -no_design_rule -lib_cell "CKBD4BWP30P140" $in_dv_port
  ...
  set_load [load_of [get_lib_pin "*/CKBD4BWP30P140/I"]] $out_clk_port
  set_load [load_of [get_lib_pin "*/CKBD4BWP30P140/I"]] $out_dv_port
}
