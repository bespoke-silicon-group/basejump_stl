...
// ## num_dly_p = 8
  ...
  wire [64-1:0] set_right, set_left, set;
    ...
    MUX2D1BWP7T30P140ULVT M0 (.Z(ctl_n[0]), .S(counter_en), .I0(ctl_r[0]), .I1(ctl_n[0]));
    DFSNQD1BWP7T30P140ULVT ctl_reg_0 (.Q(ctl_r[0]), .CP(clk_i), .D(ctl_n[0]), .SDN(async_reset_neg));
    ...
    MUX2D1BWP7T30P140ULVT M1 (.Z(ctl_n[1]), .S(counter_en), .I0(ctl_r[1]), .I1(ctl_n[1]));
    ...
    MUX2D1BWP7T30P140ULVT M2 (.Z(ctl_n[2]), .S(counter_en), .I0(ctl_r[2]), .I1(ctl_n[2]));
    ...
    MUX2D1BWP7T30P140ULVT M3 (.Z(ctl_n[3]), .S(counter_en), .I0(ctl_r[3]), .I1(ctl_n[3]));
    ...
    MUX2D1BWP7T30P140ULVT M4 (.Z(ctl_n[4]), .S(counter_en), .I0(ctl_r[4]), .I1(ctl_n[4]));
    ...
    MUX2D1BWP7T30P140ULVT M5 (.Z(ctl_n[5]), .S(counter_en), .I0(ctl_r[5]), .I1(ctl_n[5]));
    ...
    MUX2D1BWP7T30P140ULVT M6 (.Z(ctl_n[6]), .S(counter_en), .I0(ctl_r[6]), .I1(ctl_n[6]));
    ...
    MUX2D1BWP7T30P140ULVT M7 (.Z(ctl_n[7]), .S(counter_en), .I0(ctl_r[7]), .I1(ctl_n[7]));
    ...
    MUX2D1BWP7T30P140ULVT M8 (.Z(ctl_n[8]), .S(counter_en), .I0(ctl_r[8]), .I1(ctl_n[8]));
    ...
    MUX2D1BWP7T30P140ULVT M9 (.Z(ctl_n[9]), .S(counter_en), .I0(ctl_r[9]), .I1(ctl_n[9]));
    ...
    MUX2D1BWP7T30P140ULVT M10 (.Z(ctl_n[10]), .S(counter_en), .I0(ctl_r[10]), .I1(ctl_n[10]));
    ...
    MUX2D1BWP7T30P140ULVT M11 (.Z(ctl_n[11]), .S(counter_en), .I0(ctl_r[11]), .I1(ctl_n[11]));
    ...
    MUX2D1BWP7T30P140ULVT M12 (.Z(ctl_n[12]), .S(counter_en), .I0(ctl_r[12]), .I1(ctl_n[12]));
    ...
    MUX2D1BWP7T30P140ULVT M13 (.Z(ctl_n[13]), .S(counter_en), .I0(ctl_r[13]), .I1(ctl_n[13]));
    ...
    MUX2D1BWP7T30P140ULVT M14 (.Z(ctl_n[14]), .S(counter_en), .I0(ctl_r[14]), .I1(ctl_n[14]));
    ...
    MUX2D1BWP7T30P140ULVT M15 (.Z(ctl_n[15]), .S(counter_en), .I0(ctl_r[15]), .I1(ctl_n[15]));
    ...
    MUX2D1BWP7T30P140ULVT M16 (.Z(ctl_n[16]), .S(counter_en), .I0(ctl_r[16]), .I1(ctl_n[16]));
    ...
    MUX2D1BWP7T30P140ULVT M17 (.Z(ctl_n[17]), .S(counter_en), .I0(ctl_r[17]), .I1(ctl_n[17]));
    ...
    MUX2D1BWP7T30P140ULVT M18 (.Z(ctl_n[18]), .S(counter_en), .I0(ctl_r[18]), .I1(ctl_n[18]));
    ...
    MUX2D1BWP7T30P140ULVT M19 (.Z(ctl_n[19]), .S(counter_en), .I0(ctl_r[19]), .I1(ctl_n[19]));
    ...
    MUX2D1BWP7T30P140ULVT M20 (.Z(ctl_n[20]), .S(counter_en), .I0(ctl_r[20]), .I1(ctl_n[20]));
    ...
    MUX2D1BWP7T30P140ULVT M21 (.Z(ctl_n[21]), .S(counter_en), .I0(ctl_r[21]), .I1(ctl_n[21]));
    ...
    MUX2D1BWP7T30P140ULVT M22 (.Z(ctl_n[22]), .S(counter_en), .I0(ctl_r[22]), .I1(ctl_n[22]));
    ...
    MUX2D1BWP7T30P140ULVT M23 (.Z(ctl_n[23]), .S(counter_en), .I0(ctl_r[23]), .I1(ctl_n[23]));
    ...
    MUX2D1BWP7T30P140ULVT M24 (.Z(ctl_n[24]), .S(counter_en), .I0(ctl_r[24]), .I1(ctl_n[24]));
    ...
    MUX2D1BWP7T30P140ULVT M25 (.Z(ctl_n[25]), .S(counter_en), .I0(ctl_r[25]), .I1(ctl_n[25]));
    ...
    MUX2D1BWP7T30P140ULVT M26 (.Z(ctl_n[26]), .S(counter_en), .I0(ctl_r[26]), .I1(ctl_n[26]));
    ...
    MUX2D1BWP7T30P140ULVT M27 (.Z(ctl_n[27]), .S(counter_en), .I0(ctl_r[27]), .I1(ctl_n[27]));
    ...
    MUX2D1BWP7T30P140ULVT M28 (.Z(ctl_n[28]), .S(counter_en), .I0(ctl_r[28]), .I1(ctl_n[28]));
    ...
    MUX2D1BWP7T30P140ULVT M29 (.Z(ctl_n[29]), .S(counter_en), .I0(ctl_r[29]), .I1(ctl_n[29]));
    ...
    MUX2D1BWP7T30P140ULVT M30 (.Z(ctl_n[30]), .S(counter_en), .I0(ctl_r[30]), .I1(ctl_n[30]));
    ...
    MUX2D1BWP7T30P140ULVT M31 (.Z(ctl_n[31]), .S(counter_en), .I0(ctl_r[31]), .I1(ctl_n[31]));
    ...
    MUX2D1BWP7T30P140ULVT M32 (.Z(ctl_n[32]), .S(counter_en), .I0(ctl_r[32]), .I1(ctl_n[32]));
    ...
    MUX2D1BWP7T30P140ULVT M33 (.Z(ctl_n[33]), .S(counter_en), .I0(ctl_r[33]), .I1(ctl_n[33]));
    ...
    MUX2D1BWP7T30P140ULVT M34 (.Z(ctl_n[34]), .S(counter_en), .I0(ctl_r[34]), .I1(ctl_n[34]));
    ...
    MUX2D1BWP7T30P140ULVT M35 (.Z(ctl_n[35]), .S(counter_en), .I0(ctl_r[35]), .I1(ctl_n[35]));
    ...
    MUX2D1BWP7T30P140ULVT M36 (.Z(ctl_n[36]), .S(counter_en), .I0(ctl_r[36]), .I1(ctl_n[36]));
    ...
    MUX2D1BWP7T30P140ULVT M37 (.Z(ctl_n[37]), .S(counter_en), .I0(ctl_r[37]), .I1(ctl_n[37]));
    ...
    MUX2D1BWP7T30P140ULVT M38 (.Z(ctl_n[38]), .S(counter_en), .I0(ctl_r[38]), .I1(ctl_n[38]));
    ...
    MUX2D1BWP7T30P140ULVT M39 (.Z(ctl_n[39]), .S(counter_en), .I0(ctl_r[39]), .I1(ctl_n[39]));
    ...
    MUX2D1BWP7T30P140ULVT M40 (.Z(ctl_n[40]), .S(counter_en), .I0(ctl_r[40]), .I1(ctl_n[40]));
    ...
    MUX2D1BWP7T30P140ULVT M41 (.Z(ctl_n[41]), .S(counter_en), .I0(ctl_r[41]), .I1(ctl_n[41]));
    ...
    MUX2D1BWP7T30P140ULVT M42 (.Z(ctl_n[42]), .S(counter_en), .I0(ctl_r[42]), .I1(ctl_n[42]));
    ...
    MUX2D1BWP7T30P140ULVT M43 (.Z(ctl_n[43]), .S(counter_en), .I0(ctl_r[43]), .I1(ctl_n[43]));
    ...
    MUX2D1BWP7T30P140ULVT M44 (.Z(ctl_n[44]), .S(counter_en), .I0(ctl_r[44]), .I1(ctl_n[44]));
    ...
    MUX2D1BWP7T30P140ULVT M45 (.Z(ctl_n[45]), .S(counter_en), .I0(ctl_r[45]), .I1(ctl_n[45]));
    ...
    MUX2D1BWP7T30P140ULVT M46 (.Z(ctl_n[46]), .S(counter_en), .I0(ctl_r[46]), .I1(ctl_n[46]));
    ...
    MUX2D1BWP7T30P140ULVT M47 (.Z(ctl_n[47]), .S(counter_en), .I0(ctl_r[47]), .I1(ctl_n[47]));
    ...
    MUX2D1BWP7T30P140ULVT M48 (.Z(ctl_n[48]), .S(counter_en), .I0(ctl_r[48]), .I1(ctl_n[48]));
    ...
    MUX2D1BWP7T30P140ULVT M49 (.Z(ctl_n[49]), .S(counter_en), .I0(ctl_r[49]), .I1(ctl_n[49]));
    ...
    MUX2D1BWP7T30P140ULVT M50 (.Z(ctl_n[50]), .S(counter_en), .I0(ctl_r[50]), .I1(ctl_n[50]));
    ...
    MUX2D1BWP7T30P140ULVT M51 (.Z(ctl_n[51]), .S(counter_en), .I0(ctl_r[51]), .I1(ctl_n[51]));
    ...
    MUX2D1BWP7T30P140ULVT M52 (.Z(ctl_n[52]), .S(counter_en), .I0(ctl_r[52]), .I1(ctl_n[52]));
    ...
    MUX2D1BWP7T30P140ULVT M53 (.Z(ctl_n[53]), .S(counter_en), .I0(ctl_r[53]), .I1(ctl_n[53]));
    ...
    MUX2D1BWP7T30P140ULVT M54 (.Z(ctl_n[54]), .S(counter_en), .I0(ctl_r[54]), .I1(ctl_n[54]));
    ...
    MUX2D1BWP7T30P140ULVT M55 (.Z(ctl_n[55]), .S(counter_en), .I0(ctl_r[55]), .I1(ctl_n[55]));
    ...
    MUX2D1BWP7T30P140ULVT M56 (.Z(ctl_n[56]), .S(counter_en), .I0(ctl_r[56]), .I1(ctl_n[56]));
    ...
    MUX2D1BWP7T30P140ULVT M57 (.Z(ctl_n[57]), .S(counter_en), .I0(ctl_r[57]), .I1(ctl_n[57]));
    ...
    MUX2D1BWP7T30P140ULVT M58 (.Z(ctl_n[58]), .S(counter_en), .I0(ctl_r[58]), .I1(ctl_n[58]));
    ...
    MUX2D1BWP7T30P140ULVT M59 (.Z(ctl_n[59]), .S(counter_en), .I0(ctl_r[59]), .I1(ctl_n[59]));
    ...
    MUX2D1BWP7T30P140ULVT M60 (.Z(ctl_n[60]), .S(counter_en), .I0(ctl_r[60]), .I1(ctl_n[60]));
    ...
    MUX2D1BWP7T30P140ULVT M61 (.Z(ctl_n[61]), .S(counter_en), .I0(ctl_r[61]), .I1(ctl_n[61]));
    ...
    MUX2D1BWP7T30P140ULVT M62 (.Z(ctl_n[62]), .S(counter_en), .I0(ctl_r[62]), .I1(ctl_n[62]));
    ...
    MUX2D1BWP7T30P140ULVT M63 (.Z(ctl_n[63]), .S(counter_en), .I0(ctl_r[63]), .I1(ctl_n[63]));
    DFCNQD1BWP7T30P140ULVT ctl_reg_63 (.Q(ctl_r[63]), .CP(clk_i), .D(ctl_n[63]), .CDN(async_reset_neg));
