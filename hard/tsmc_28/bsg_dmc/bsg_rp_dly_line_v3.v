...
// ## num_dly_p = 24
  ...
  assign n[0] = clk_180;
    ...
    CKBD8BWP7T30P140ULVT B8 (.Z(n[9]), .I(n[8]));


    CKBD8BWP7T30P140ULVT B9 (.Z(n[10]), .I(n[9]));


    CKBD8BWP7T30P140ULVT B10 (.Z(n[11]), .I(n[10]));


    CKBD8BWP7T30P140ULVT B11 (.Z(n[12]), .I(n[11]));


    CKBD8BWP7T30P140ULVT B12 (.Z(n[13]), .I(n[12]));


    CKBD8BWP7T30P140ULVT B13 (.Z(n[14]), .I(n[13]));


    CKBD8BWP7T30P140ULVT B14 (.Z(n[15]), .I(n[14]));


    CKBD8BWP7T30P140ULVT B15 (.Z(n[16]), .I(n[15]));


    CKBD8BWP7T30P140ULVT B16 (.Z(n[17]), .I(n[16]));


    CKBD8BWP7T30P140ULVT B17 (.Z(n[18]), .I(n[17]));


    CKBD8BWP7T30P140ULVT B18 (.Z(n[19]), .I(n[18]));


    CKBD8BWP7T30P140ULVT B19 (.Z(n[20]), .I(n[19]));


    CKBD8BWP7T30P140ULVT B20 (.Z(n[21]), .I(n[20]));


    CKBD8BWP7T30P140ULVT B21 (.Z(n[22]), .I(n[21]));


    CKBD8BWP7T30P140ULVT B22 (.Z(n[23]), .I(n[22]));


    CKBD8BWP7T30P140ULVT B23 (.Z(n[24]), .I(n[23]));


  // Delay value ignored in synthesis
  wire #100 clk_dly = n[24];
