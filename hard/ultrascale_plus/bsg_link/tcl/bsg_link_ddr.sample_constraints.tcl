...
# User should include this file in their own Vivado tcl flow
# Then call the function to use the constraints

puts "Info: Start script bsg_link_ddr_sample_constraints\n"

proc bsg_link_ddr_sample_constraints { \
  fmc_input_clk_period                 \
  fmc_input_clk_name                   \
  fmc_input_clk_port                   \
  fmc_input_data_port                  \
  fmc_output_clk_name                  \
...
puts "Info: Completed script bsg_link_ddr_sample_constraints"
