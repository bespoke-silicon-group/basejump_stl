...
`define bsg_mem_1rw_sync_mask_write_bit_macro(words,bits,mux) \
  if (harden_p && els_p == words && width_p == bits)          \
    begin: macro                                              \
      tsmc40_1rw_d``words``_w``bits``_m``mux``_bit            \
        mem                                                   \
          ( .CLK   ( clk_i     )                              \
          , .A     ( addr_i    )                              \
          , .D     ( data_i    )                              \
        ...
        begin: bank                                                       \
          tsmc40_1rw_d``words``_w``bits``_m``mux``_bit                    \
            mem                                                           \
              ...
              , .CEB   ( ~v_i                                        )    \
              , .WEB   ( ~w_i                                        )    \
              , .BWEB  ( ~w_mask_i[i*(width_p/banks)+:width_p/banks] )    \
              );                                                          \
        end: bank                                                         \
    end: macro
...
module bsg_mem_1rw_sync_mask_write_bit #( parameter width_p = -1
  ...
  `bsg_mem_1rw_sync_mask_write_bit_macro( 64, 7,2) else
  `bsg_mem_1rw_sync_mask_write_bit_macro( 64,15,2) else
  ...
  `bsg_mem_1rw_sync_mask_write_bit_macro(512, 4,4) else
