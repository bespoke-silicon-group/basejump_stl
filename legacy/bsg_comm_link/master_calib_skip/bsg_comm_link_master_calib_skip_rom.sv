...
module bsg_comm_link_master_calib_skip_rom #(parameter `BSG_INV_PARAM(width_p), `BSG_INV_PARAM(addr_width_p))
...
`BSG_ABSTRACT_MODULE(bsg_comm_link_master_calib_skip_rom)
